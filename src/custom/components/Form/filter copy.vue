<template>
  <div style="margin-bottom: 16px;padding:10px ;background-color: white;">
    <BasicForm @register="registerForm" @submit="handleSubmit"  :style="{width: `calc(100% - ${slot+30}px)`}">
    </BasicForm>
    <Select v-model:value="selectValue" :bordered=false :showArrow=false :options="options" class="add-condition"
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return {
      selectValue, options, registerForm, handleChange, handleSubmit,slot:props.slotWidth
    }
  }
})
</script>
